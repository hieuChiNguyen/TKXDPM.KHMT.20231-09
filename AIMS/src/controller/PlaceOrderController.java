...
public class PlaceOrderController extends BaseController{
     ...
     * @throws SQLException
     */
    public Order createOrder(Invoice invoice, DeliveryInfor deliveryInfor) throws SQLException{
   ...
   * @throws IOException
   */
    public String validateDeliveryInfo(DeliveryInfor deliveryInfor) throws InterruptedException, IOException{
    	return deliveryInfor.validateDeliveryInfo();
    }
