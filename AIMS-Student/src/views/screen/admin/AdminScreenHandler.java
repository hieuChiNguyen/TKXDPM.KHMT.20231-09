...
public class AdminScreenHandler extends BaseScreenHandler{
    ...
    public AdminScreenHandler(Stage stage, String screenPath) throws IOException {
		...
		acceptOrderBtn.setOnMouseClicked(e -> {
...
//                ConfirmOrderController confirmOrderController = loader.getController();
                ...
                // Đặt trang confirm_order.fxml vào AnchorPane
                contentAdminAnchorPane.getChildren().setAll(confirmOrderParent);

                // Nếu bạn muốn truyền dữ liệu cho controller của trang confirm_order.fxml
                // confirmOrderController.setData(data);
